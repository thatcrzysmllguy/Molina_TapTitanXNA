...
namespace TapTitanXNA_JuliusMolina
{
    ...
    public class Button
    {
        ...
        public bool Update(GameTime gameTime, int mx,
            int my, bool mpressed, bool prev_mpressed)
        {
        ...
        public bool hitImage(float tx, float ty, Texture2D texture,
                                int x, int y)
        {
            return (x >= tx &&
                    x <= tx + texture.Width &&
        ...
        public bool hitImageAlpha(Rectangle rect, Texture2D texture,
                                int x, int y)
        {
